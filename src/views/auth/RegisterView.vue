      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleRegister">
        ...
        <div>
          <button
            ...
            class="disabled:opacity-50 w-full flex justify-center py-4 px-4 border text-sm font-medium rounded-md text-white bg-gray-700 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-200"
          >
    ...
    const handleRegister = async () => {
      ...
      try {
        ...
        await authService.register({
          ...
          role: 'Perfil Movimentador', // Definindo a role padrão
        })
